      ...
      >
        <div>
          <div className="space-y-6 max-w-xl mx-auto">
            {/*mx-auto--> automatic left and right margins */}
            <h1
              data-aos="fade-up"
            ...
            <p data-aos="fade-up" className="text-center sm:px-20">
              Available on iOS and Android: Search for Black Budyy Car Rental in the App Store or Google Play Store and download it for free.
            </p>
            <div
              data-aos="fade-up"
